  ...
  return (
      <div className="centered">
          <div className="about">
            ...
            <p>OTP is a game about submitting OTPs to a webpage really fast. This is an alpha version - v0.3 that is why some features may be fully baked. Despite of that I hope you will enjoy this little time waster game. Now go there and type those OTPs Made with ❤️ by Ayushman</p>
          </div>
