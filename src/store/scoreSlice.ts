...
const scoreSlice = createSlice({
    ...
    initialState: {
        ...
        life: 3,
        isGameOver: false,
        highScore: localStorage.getItem('hs') ? Number(localStorage.getItem('hs')) : 0,
    },
    reducers: {
...
export const {incrementScore, decrementScore, incrementLife, decrementLife, setIsGameOver, setLife, setScore, setHighScore} = scoreSlice.actions;
